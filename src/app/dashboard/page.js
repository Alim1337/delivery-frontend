...
export default function BusinessDashboard() {
  ...
  const exportCSV = () => {
    ...
    link.href = url;
    link.download = `deliveries-${new Date()
      .toISOString()
      .slice(0, 10)}.csv`;
    link.click();
  ...
  const stats = [
    ...
    {
      label: "Cancelled",
      value: deliveries.filter((d) => d.status === "CANCELLED")
        .length,
      icon: XCircle,
      color: "red",
    },
      ...
      <div className="max-w-6xl mx-auto p-6">
        ...
        <div className="flex justify-between items-center mb-8">
          ...
          <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
            ...
            <button
              onClick={() =>
                router.push("/business/new-delivery")
              }
                ...
                <tbody className="divide-y divide-gray-50">
                  {deliveries.map((d) => (
                    ...
                    >
                      ...
                      <td className="px-5 py-4 text-gray-500 max-w-32 truncate">
                        {d.itemDescription}
                      </td>
